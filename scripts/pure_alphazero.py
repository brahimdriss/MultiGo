...
def do_self_play(
    ...
    red_agent = zero.ZeroAgent(model, encoder, rounds_per_move=rounds, c=c, alpha=alpha)
    ...
    for i in range(37, 55):
        ...
        with open(outfile, "w") as f:
            with redirect_stdout(f):
                ...
                experience_files = []
                workers = []
                # gpu_frac = 0.9 / float(args.num_workers)
                gpu_frac = 0.9 / 9
                ...
                # assert games_per_worker >= 3,f" games_per_worker = {games_per_worker} is less than 3, not enough games to collect experience"
        ...
        with open(outfile, "w") as f:
            ...
            # train(outfile, exp1_file, exp2_file, model_out)
